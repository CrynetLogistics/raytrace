...
int main(){
	...
	string FILENAME;
	int BSPBVH_DEPTH, ENABLE_TEXTURES;
	...
	cout<<"PLEASE ENTER BSPBVH_DEPTH:";

	cin>>BSPBVH_DEPTH;

	cout<<"INITIALISE TEXTURE SYSTEM?";

	cin>>ENABLE_TEXTURES;

	raytrace(USE_GPU, SCREEN_WIDTH, SCREEN_HEIGHT, FILENAME, MSAA_LEVEL, BSPBVH_DEPTH, ENABLE_TEXTURES);
}